...
namespace Extension
{
    public sealed partial class Engine
    {
        ...
        {
            get => _buffer.AsReadOnlySpan<byte>(_offset + 3, ManufacturerCodeLength);
            set => value.CopyTo(_buffer.AsSpan<byte>(_offset + 3, ManufacturerCodeLength));
        }

        public Span<byte> ManufacturerCodeAsSpan()
        {
            return _buffer.AsSpan<byte>(_offset + 3, ManufacturerCodeLength);
        }

        public const string ManufacturerCodeCharacterEncoding = "US-ASCII";
        public static Encoding ManufacturerCodeResolvedCharacterEncoding = Encoding.GetEncoding(ManufacturerCodeCharacterEncoding);
        ...
        {
            _buffer.SetNullTerminatedBytesFromString(ManufacturerCodeResolvedCharacterEncoding, value, _offset + 3, ManufacturerCodeLength, ManufacturerCodeNullValue);
        }
        public string GetManufacturerCode()
        {
            return _buffer.GetStringFromNullTerminatedBytes(ManufacturerCodeResolvedCharacterEncoding, _offset + 3, ManufacturerCodeLength, ManufacturerCodeNullValue);
        }
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            for (int i = 0; i < ManufacturerCodeLength && this.GetManufacturerCode(i) > 0; ++i)
            {
                builder.Append((char)this.GetManufacturerCode(i));
            }
            builder.Append('|');
            ...
            {
                this.Booster.BuildString(builder);
            }
            else
            {
                builder.Append("null");
