...
pub mod parser_field_tests {
    use interop_reserializer::{lexer::Lexer, parser::parser_field::{parse_field_def, parse_field_defs}, parser_types::{ParsedField, ParsedVariableType}};
    ...
    pub fn test_parse_field_with_generic_type() {
        ...
        let expect = ParsedField {
            field_name: "TestField".to_string(),
            field_type: 
                ParsedVariableType::generic("Union",
                    vec![
    ...
    pub fn test_multiple_fields() {
        let field_def = r#"TestField1::Int64
...
"#;
        ...
        let expect = vec![
            ParsedField { field_name: "TestField1".to_string(), field_type: ParsedVariableType::scaler("Int64")},
            ParsedField {
            ...
            ParsedField { field_name: "TestField3".to_string(), field_type: ParsedVariableType::scaler("Float64")},
            ParsedField { field_name: "TestField4".to_string(), field_type: ParsedVariableType::scaler("TimeStamp")},
        ];
